...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="landing">PENAT.</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="about.html" class="nav-link">Riwayat</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }"><br><br>
           <i class="far fa-paper-plane fa-2x"></i><h1 class="" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><strong>LAPOR</strong></h1>
           
            <!-- <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="laporan" class="btn btn-primary btn-outline-white px-5 py-3">Lapor</a></p> -->
          
          <form action="simpan.php" method="post" enctype="multipart/form-data">
          <textarea name="" id="" style="padding:20px; border-radius:20px 20px 0px 0px; font-size:13px;  margin-bottom:5px;" cols="70" rows="6" placeholder="Ketik laporan ada disini..."></textarea>
          <input type="file" name="" style="background-color:white; width:93%; border-radius:0px 0px 20px 20px; text-size:10px;" class="btn btn-primary mx-auto" placeholder="Pilih Berkas"> </input>
          
          <!-- <input type="file" id="pic" name="pic" style="display:none;" onchange="document.getElementById('filename').value=this.value">
          <input type="button" style="font-size:13px;" class="btn btn-primary mx-auto" value="Pilih Gambar / File" onclick="document.getElementById('pic').click()"> <br>
          <input type="text" id="filename" style="background-color:white; width:93%; text-align:center; border-radius:0px 0px 20px 20px; font-size:13px; margin-top:7px;" placeholder="Lokasi penyimpanan file" disabled> <br> -->
          
          <button type="submit" style="margin-top:10px; width:30%;" class="btn btn-primary mx-auto">Kirim</button>
          </form>
          </div>
        </div>
      </div>
        ...
        <div class="row no-gutters d-flex align-items-center" data-scrollax=" properties: { translateY: '-30%'}">
          ...
          <div class="col-md-3 mb-3">
            <a href="#" class="featured-img">
              ...
              <img src="{{asset('tmp/images/image_1.jpg')}}" class="img-fluid" alt="">
              <div class="text p-4 d-flex align-items-center">
                <div class="user d-flex align-items-center">
                  <div class="user-img mr-3" style="background-image: url({{asset('tmp/images/person_1.jpg')}};"></div>
                ...
                <div class="row no-gutters d-flex align-items-end">
                  ...
                  <div class="col-md-8">
                    <a href="#" class="featured-img">
                      ...
                      <img src="{{asset('tmp/images/image_5.jpg')}}" class="img-fluid" alt="">
                      <div class="text p-4 d-flex align-items-center">
                        <div class="user d-flex align-items-center">
                  ...
                  <div class="col-md-4">
                    <a href="#" class="featured-img">
                      ...
                      <img src="{{asset('tmp/images/image_4.jpg')}}" class="img-fluid" alt="">
                      <div class="text p-4 d-flex align-items-center">
                        <div class="user d-flex align-items-center">
                          <div class="user-img mr-3" style="background-image: url({{asset('tmp/images/person_1.jpg')}};"></div>
                ...
                <div class="row no-gutters d-flex align-items-start">
                  <div class="col-md-8">
                    <a href="#" class="featured-img">
                      ...
                      <img src="{{asset('tmp/images/image_6.jpg')}}" class="img-fluid" alt="">
                      <div class="text p-4 d-flex align-items-center">
                        <div class="user d-flex align-items-center">
                          <div class="user-img mr-3" style="background-image: url(asset('tmp/images/person_1.jpg')}};"></div>
                          <h3>John Bruce <br><span class="position">Designer</span></h3>
                  ...
                  <div class="col-md-4">
                    <a href="#" class="featured-img">
                      ...
                      <img src="{{asset('tmp/images/image_3.jpg')}}" class="img-fluid" alt="">
                      <div class="text p-4 d-flex align-items-center">
                        <div class="user d-flex align-items-center">
                          <div class="user-img mr-3" style="background-image: url({{asset('tmp/images/person_1.jpg')}};"></div>
                          <h3>John Bruce <br><span class="position">Designer</span></h3>
          ...
          <div class="col-md-3">
            <a href="#" class="featured-img">
              ...
              <img src="{{asset('tmp/images/image_2.jpg')}}" class="img-fluid" alt="">
              <div class="text p-4 d-flex align-items-center">
                <div class="user d-flex align-items-center">
                  <div class="user-img mr-3" style="background-image: url({{asset('tmp/images/person_1.jpg')}};"></div>
                  <h3>John Bruce <br><span class="position">Designer</span></h3>
      ...
      <div class="container" style="margin-top:-100px;">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-6 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-4"> Proses PENAT mengeksekusi Laporan</h2>
            </div>
        </div>
        <div class="row">
